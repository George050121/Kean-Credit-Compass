...
function CourseUpload() {
  ...
  // TODO: Backend Integration - Fetch available majors from API
  // API Endpoint: GET /api/majors
  // Response: { majors: ['Computer Science', 'IT', ...] }
  ...
  const handleFileSelect = async (selectedFile) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // TODO: Backend Integration - POST request to save course data
        // API Endpoint: POST /api/courses/upload
        // Request Body: { major: selectedMajor, courses: rows }
        // Response: { success: true, studentId: string, courses: array }
        // Example:
        // const response = await fetch('/api/courses/upload', {
        //   method: 'POST',
        //   headers: { 'Content-Type': 'application/json' },
        //   body: JSON.stringify({ major: selectedMajor, courses: rows })
        // });
